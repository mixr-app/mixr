...
var _user$project$Shared_Styles$styles = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'margin', _1: '0 auto'},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'max-width', _1: '70em'},
			_1: {
				ctor: '::',
...
var _user$project$Main$divWidth = F2(
	function (width, attributes) {
...
var _user$project$Main$recipeToHtml = function (recipe) {
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('col-sm-3 card'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
				...
				},
				{
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(ingredientString),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
...
var _user$project$Main$navbar = A2(
	...
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('navbar navbar-light bg-faded'),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('miXr'),
				_1: {ctor: '[]'}
			}),
		_1: {ctor: '[]'}
	});
...
var _user$project$Main$decodeIngredient = A4(
	_elm_lang$core$Json_Decode$map3,
	_user$project$Main$Ingredient,
	A2(_elm_lang$core$Json_Decode$field, 'id', _elm_lang$core$Json_Decode$int),
	A2(_elm_lang$core$Json_Decode$field, 'name', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'description', _elm_lang$core$Json_Decode$string));
var _user$project$Main$decodeIngredients = _elm_lang$core$Json_Decode$list(_user$project$Main$decodeIngredient);
var _user$project$Main$decodeRecipeIngredients = _elm_lang$core$Json_Decode$list(
	A2(_elm_lang$core$Json_Decode$field, 'ingredient', _user$project$Main$decodeIngredient));
var _user$project$Main$Recipe = F3(
	function (a, b, c) {
		return {id: a, name: b, ingredients: c};
	});
var _user$project$Main$decodeRecipes = _elm_lang$core$Json_Decode$list(
	A4(
		_elm_lang$core$Json_Decode$map3,
		_user$project$Main$Recipe,
		A2(_elm_lang$core$Json_Decode$field, 'id', _elm_lang$core$Json_Decode$int),
		A2(_elm_lang$core$Json_Decode$field, 'name', _elm_lang$core$Json_Decode$string),
...
var _user$project$Main$getIngredients = function () {
	var url = 'http://localhost:8080/ingredients/';
	var request = A2(_elm_lang$http$Http$get, url, _user$project$Main$decodeIngredients);
	return A2(_elm_lang$http$Http$send, _user$project$Main$LoadedIngredients, request);
}();
...
var _user$project$Main$CheckIngredient = F2(
	function (a, b) {
		return {ctor: 'CheckIngredient', _0: a, _1: b};
	});
var _user$project$Main$ingredientToHtml = function (ingredient) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
					...
					_1: {
						...
						_0: _elm_lang$html$Html_Attributes$for(
							A2(
								_elm_lang$core$Basics_ops['++'],
								'cbox',
								_elm_lang$core$Basics$toString(ingredient.id))),
						_1: {ctor: '[]'}
					}
				},
				{
					...
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text(ingredient.name),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
												...
												_1: {
													...
													_1: {
														...
														_0: _elm_lang$html$Html_Events$onCheck(
															function (checked) {
																return A2(_user$project$Main$CheckIngredient, checked, ingredient.id);
															}),
														_1: {ctor: '[]'}
													}
												}
...
var _user$project$Main$RefreshJson = {ctor: 'RefreshJson'};
